...
//        String sql = "SELECT count(*) from airports_temp a join flight_data_temp f on f.origin = a.code";
        String sql = "SELECT a1.name, count(a1.name) as total_flight, count(DISTINCT a2.name) as total_dest, sum(air_time) as total_time FROM flight_data_temp f\n" +
